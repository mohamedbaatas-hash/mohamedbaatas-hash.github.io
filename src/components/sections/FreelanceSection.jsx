...
import { FREELANCE_SOLUTIONS } from '../../data/portfolioData';
...
export function FreelanceSection() {
  ...
  return (
    <section id="freelance" className="py-20 border-b border-border-slate/80 bg-obsidian">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading
          tag="COMMERCIAL_SOFTWARE"
          title="Freelance Engineering & Bespoke Software"
          description="High-reliability desktop solutions, access control ERPs, and custom scientific data visualizers designed and deployed for commercial business clients."
        />

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {FREELANCE_SOLUTIONS.map((sol) => (
